...
int main()
{
    ...
    cout<<"\nNilai d = a || b = "<<d<<endl; //Outputnya Nilai d = a || b = 1,artinya benar karena salah satu statementnya benar yaitu statement dari variabel a
    cout<<"\nNilai e = ! (c) = "<<e<<endl; //Outputnya Nilai e = ! (c) = 0,artinya benar karena statement c akan dibuat kebalikannya di variabel a dan pernyatan c itu salah tapi dibalikkan dengan ! jadi benar
